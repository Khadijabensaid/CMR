...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
	...
	Matrice matrice =DataBaseMethodes.GetMatriceDe(demande);
    ...
    <!-- DashBoard  -->
      ...
      <input type="hidden" name="ToDo" value="matrice" />
        ...
        <div class="container-table100">
			...
			<input type="hidden" name="id-demande" value="<%=demande.getId() %>" />
				<table id="champs" role="table"  >
			      ...
			      <tr role="row">
					...
					<tr role="row">
					<% String reponse = matrice.getReponses().get(k);
					   String score =  matrice.getScores().get(k);
					
					
					%>
				        <td role="cell">facteur x</td> 
				        <td role="cell"> <%= reponse %></td>
				        <td role="cell">chi haja 1</td><td role="cell">chi haja 5</td>
						<td role="cell"> <%=  score%></textarea></td>
         ...
         <br> 
          <h4 class="w3-center">         Score Total : <%= matrice.getScore()  %> </h4>
