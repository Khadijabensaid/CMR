  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        ...
        <form action="DevelopperServlet" method="post">
				<input type="hidden" name="action" value="acceuil" />
				<button class="w3-button w3-block w3-theme-l1 w3-left-align" type="submit" ><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Acceuil</button>              
			</form>
			
            <form action="DevelopperServlet" method="post">
				<input type="hidden" name="action" value="upload" />
				<button class="w3-button w3-block w3-theme-l1 w3-left-align" type="submit" ><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Upload File</button>              
			</form>
    ...
    <div class="w3-col m7">
      ...
      <div class="container w3-card w3-white w3-round  " style=" min-height: 250px;"><br>
        <h4 class="w3-center">File</h4><br>
        <hr class="w3-clear">
        
        

 		<form action="DevelopperActions" method="post" enctype="multipart/form-data">
		 		<input type="hidden" name="action" value="upload" />
